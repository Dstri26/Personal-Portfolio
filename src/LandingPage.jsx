...
import CircularTimeline from "./components/WorkPortfolio/CircularTimeline";
...
const LandingPage = () => {
  ...
  const options = {
    ...
    minSize: Math.min(window.innerWidth, window.innerHeight) * 0.1,
    gutter: 10,
    fringeWidth: 100,
    numCols: 6,
    yRadius: 100,
      ...
      <Parallax pages={5} style={{ top: "0", left: "0" }} className="animation">
        ...
        <ParallaxLayer offset={2} speed={0}>
          ...
          >
            ...
            <div className="col-md-5">
              <p className="display-4" style={{ textAlign: "right" }}>
                What's in the Tech Voyager's Toolkit?
              </p>
              <p
